...
function Test() {
  ...
  useEffect(() => {
    if (questions.length > 0) {
      setQst_paper_code(questions[0]["qst_paper_code"]);
      // console.log(questions[0]["qst_paper_code"]);
    }
  }, [questions]);
  ...
  async function submit_ans() {
    ...
    page_navigate(`${sub_name}_week`);
  }

  //  THESE MUST BE AFTER ALL HOOKS
  // if (loading) return <h2>Loading...</h2>;
  if (!questions.length) return <div className="container text-center mt-5 bg-light p-5 shadow-lg rounded text-primary">
    <h1>
      Test Questions are not available right now.
    </h1>
  </div>
...
//     const mark_response = await fetch(
//       "http://127.0.0.1:8000/week_add_ansto_db/",
//       {
//         method: "POST",
//         headers: { "Content-Type": "application/json" },
//         body: JSON.stringify([
...
//         //   ` Don't switched tabs! More than ${
//         //     2 - warnings
//         //   } times  Exam page will be  closed automaticaly`
//         // );
...
//           <div className="col-7 text-start">
//             <h1 className="fw-bold">Data Analysis Test - {qst_id}</h1>
//           </div>
//           <div className="col-5 text-end">
//             <button className="btn btn-warning mt-2" onClick={submit_ans} disabled={dis}>
//               Submit Test
//             </button>
//             <div className="time">
//               <h3>
...
//           </div>
//         </div>
//         <div className="qst row mt-5 ">
//           <div className="col-12 ">
//             {questions &&
//               questions.map((items) => (
//                 <div key={items.id}>
//                   <div className="form-check">
//                     <div className="mb-4 p-3 border rounded shadow-lg">
